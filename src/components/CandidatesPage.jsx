...
const CandidatesPage = () => {
  ...
  const { 
    ...
    refetch 
  } = useCandidates(filters, pagination);
    ...
    return (
      <div className="container">
        <div className="page-header">
          ...
          <p className="page-subtitle">Manage all candidates across all jobs</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="card">
          <div className="empty-state">
            ...
            <button onClick={() => setFilters({ search: '', stage: '', sort: 'createdAt' })} className="btn btn-primary">
              Clear Filters
            </button>
          </div>
        </div>
